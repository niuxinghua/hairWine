//
//  DetailExperienceViewController.m
//  HaierWine
//
...
@interface DetailExperienceViewController (){
...
@implementation DetailExperienceViewController
...
- (void)viewDidLoad
{
    ...
    NSString *string = [NSString stringWithFormat:@"Experience%@",_ExperienceId];
...
-(void)requestMethod
{
   ...
   // loadingView.frame = CGRectMake(0, 64, self.view.bounds.size.width, self.view.bounds.size.height);
    ...
    [dic setValue:_ExperienceId forKey:@"id"];
