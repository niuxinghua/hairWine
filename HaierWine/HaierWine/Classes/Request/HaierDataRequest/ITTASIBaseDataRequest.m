...
//                [_request setPostBody:[NSMutableData dataWithData:jsonFormatPostData]];
                    ...
                    NSData * jsonFormatPostData = [allParams objectForKey:@"avatar"];
                    postBodySize += [jsonFormatPostData length];
                    NSString *contentType = @"application/json; charset=utf-8";
//                    NSString *contentType = @"application/octet-stream; charset=utf-8";
//                    NSInputStream  * inputStream = [NSInputStream inputStreamWithData:jsonFormatPostData];
                    [_request addRequestHeader:@"Content-Type" value:contentType];
...
//    [_request addRequestHeader:@"appid" value:APPID];
//    [_request addRequestHeader:@"appKey" value:APPKEY];
//    [_request addRequestHeader:@"appVersion" value:APPVERSION];
//    [_request addRequestHeader:@"clientid" value:[[[UIDevice currentDevice] identifierForVendor] UUIDString]];
//    [_request addRequestHeader:@"accessToken" value:DATA_ENV.accessToken];
    //身份验证
    [_request setUsername:@"admin"];
    [_request setPassword:@"admin1881"];    
    //NSLog(@"request--------------:%@",_request.requestHeaders);
